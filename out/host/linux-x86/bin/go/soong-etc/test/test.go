...
var t = []testing.InternalTest{
	...
	{"TestPrebuiltTakeSnapshot", pkg.TestPrebuiltTakeSnapshot},
	...
	{"TestSnapshotEtcWithOrigin", pkg.TestSnapshotEtcWithOrigin},

	{"TestSnapshotEtcWithOriginAndPrefer", pkg.TestSnapshotEtcWithOriginAndPrefer},

	{"TestSnapshotEtcWithoutOrigin", pkg.TestSnapshotEtcWithoutOrigin},

	{"TestSnapshotWithFilename", pkg.TestSnapshotWithFilename},
