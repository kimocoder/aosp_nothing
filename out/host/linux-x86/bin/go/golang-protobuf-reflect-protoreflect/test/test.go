...
var t = []testing.InternalTest{
	...
	{"TestFullNameIsValid", pkg.TestFullNameIsValid},

	{"TestNameAppend", pkg.TestNameAppend},

	{"TestNameIsValid", pkg.TestNameIsValid},

	{"TestSourcePathString", pkg.TestSourcePathString},

	{"TestValue", pkg.TestValue},
...
func (matchString) ImportPath() string {
	return "google.golang.org/protobuf/reflect/protoreflect"
}
