...
import (
	...
	pkg "google.golang.org/protobuf/encoding/protowire"
)

var t = []testing.InternalTest{

	{"TestBytes", pkg.TestBytes},

	{"TestField", pkg.TestField},

	{"TestFixed32", pkg.TestFixed32},

	{"TestFixed64", pkg.TestFixed64},

	{"TestGroup", pkg.TestGroup},

	{"TestTag", pkg.TestTag},

	{"TestVarint", pkg.TestVarint},

	{"TestZigZag", pkg.TestZigZag},
...
func (matchString) ImportPath() string {
	return "google.golang.org/protobuf/encoding/protowire"
}
