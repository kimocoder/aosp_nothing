...
import (
	...
	pkg "android/soong/ui/status"
)

var t = []testing.InternalTest{

	{"TestBasicUse", pkg.TestBasicUse},

	{"TestCriticalPath", pkg.TestCriticalPath},

	{"TestExtraActions", pkg.TestExtraActions},

	{"TestFinishEarly", pkg.TestFinishEarly},

	{"TestKatiExtraIncludes", pkg.TestKatiExtraIncludes},

	{"TestKatiFailOnError", pkg.TestKatiFailOnError},

	{"TestKatiNormalCase", pkg.TestKatiNormalCase},

	{"TestNinjaReader_Close", pkg.TestNinjaReader_Close},

	{"TestNinjaReader_CorrectErrorHint", pkg.TestNinjaReader_CorrectErrorHint},

	{"TestRunningWhenFinished", pkg.TestRunningWhenFinished},
...
func (matchString) ImportPath() string {
	return "android/soong/ui/status"
}
