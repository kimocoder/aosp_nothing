...
import (
	...
	pkg "github.com/google/go-cmp/cmp/internal/diff"
)

var t = []testing.InternalTest{

	{"TestDifference", pkg.TestDifference},

	{"TestDifferenceFuzz", pkg.TestDifferenceFuzz},

	{"TestResult", pkg.TestResult},
...
func (matchString) ImportPath() string {
	return "github.com/google/go-cmp/cmp/internal/diff"
}
