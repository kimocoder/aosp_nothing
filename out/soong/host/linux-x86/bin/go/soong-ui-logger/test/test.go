...
import (
	...
	pkg "android/soong/ui/logger"
)

var t = []testing.InternalTest{

	{"TestCreateFileWithRotation", pkg.TestCreateFileWithRotation},

	{"TestFatal", pkg.TestFatal},

	{"TestNonFatal", pkg.TestNonFatal},

	{"TestPanic", pkg.TestPanic},

	{"TestRecoverFatal", pkg.TestRecoverFatal},

	{"TestRecoverNonFatal", pkg.TestRecoverNonFatal},

	{"TestRuntimePanic", pkg.TestRuntimePanic},
...
func (matchString) ImportPath() string {
	return "android/soong/ui/logger"
}
