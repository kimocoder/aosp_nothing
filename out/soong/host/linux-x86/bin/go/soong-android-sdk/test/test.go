...
import (
	...
	pkg "android/soong/android_sdk"
)

var t = []testing.InternalTest{

	{"TestRemapPackageSpecs", pkg.TestRemapPackageSpecs},

	{"TestSdkRepoHostDeps", pkg.TestSdkRepoHostDeps},
...
func (matchString) ImportPath() string {
	return "android/soong/android_sdk"
}
