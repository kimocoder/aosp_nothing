...
import (
	...
	pkg "android/soong/starlark_fmt"
)

var t = []testing.InternalTest{

	{"TestListWithNonZeroIndent", pkg.TestListWithNonZeroIndent},

	{"TestPrintDict", pkg.TestPrintDict},

	{"TestPrintDictWithIndent", pkg.TestPrintDictWithIndent},

	{"TestPrintEmptyList", pkg.TestPrintEmptyList},

	{"TestPrintEmptyStringList", pkg.TestPrintEmptyStringList},

	{"TestPrintMultiElementList", pkg.TestPrintMultiElementList},

	{"TestPrintMultiElementStringList", pkg.TestPrintMultiElementStringList},

	{"TestPrintSingleElementList", pkg.TestPrintSingleElementList},

	{"TestPrintSingleElementStringList", pkg.TestPrintSingleElementStringList},

	{"TestStringListDict", pkg.TestStringListDict},

	{"TestStringListDictEmpty", pkg.TestStringListDictEmpty},
...
func (matchString) ImportPath() string {
	return "android/soong/starlark_fmt"
}
