...
import (
	...
	pkg "google.golang.org/protobuf/internal/order"
)

var t = []testing.InternalTest{

	{"TestFieldOrder", pkg.TestFieldOrder},

	{"TestKeyOrder", pkg.TestKeyOrder},
...
func (matchString) ImportPath() string {
	return "google.golang.org/protobuf/internal/order"
}
