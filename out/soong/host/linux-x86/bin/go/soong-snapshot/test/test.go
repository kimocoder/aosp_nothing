...
import (
	...
	pkg "android/soong/snapshot"
)

var t = []testing.InternalTest{

	{"TestFakeHostSnapshotDisable", pkg.TestFakeHostSnapshotDisable},

	{"TestFakeHostSnapshotEnable", pkg.TestFakeHostSnapshotEnable},

	{"TestHostSnapshot", pkg.TestHostSnapshot},
